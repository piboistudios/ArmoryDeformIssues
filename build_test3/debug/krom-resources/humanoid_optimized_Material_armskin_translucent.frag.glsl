...
void main()
{
    ...
    vec3 RGB_Color_res = vec3(0.104531340301036834716796875, 0.4999999105930328369140625, 0.02874119393527507781982421875);
    ...
    if (receiveShadow)
    {
        if (lightShadow == 1)
        {
            ...
            if (lightType == 0)
            {
                int param;
                int param_1;
                mat4 _869 = getCascadeMat(distance(eye, wposition), param, param_1);
                int casi = param;
        ...
        else
        {
            ...
            {
                vec3 param_2 = -l;
                float _928 = PCFCube(shadowMapCube, lp, param_2, shadowsBias, lightProj, n);
                visibility *= _928;
            }
        }
    }

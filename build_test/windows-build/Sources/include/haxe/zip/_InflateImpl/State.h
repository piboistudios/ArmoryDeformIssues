...
class State_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("haxe.zip._InflateImpl.State","\xa0","\xc2","\x8b","\xf6"); }
		::String __ToString() const { return HX_HCSTRING("State.","\x1d","\x4d","\x90","\x3a") + _hx_tag; }

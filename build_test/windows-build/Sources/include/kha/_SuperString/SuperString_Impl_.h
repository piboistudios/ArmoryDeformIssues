...
class HXCPP_CLASS_ATTRIBUTES SuperString_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< SuperString_Impl__obj > __new() {
			hx::ObjectPtr< SuperString_Impl__obj > __this = new SuperString_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< SuperString_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
			SuperString_Impl__obj *__this = (SuperString_Impl__obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(SuperString_Impl__obj), false, "kha._SuperString.SuperString_Impl_"));
			*(void **)__this = SuperString_Impl__obj::_hx_vtable;
			return __this;
		}
		...
		static ::String substring(::String this1,int start, ::Dynamic end);

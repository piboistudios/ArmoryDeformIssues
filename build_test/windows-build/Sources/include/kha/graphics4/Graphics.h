...
class HXCPP_CLASS_ATTRIBUTES Graphics_obj {
	public:
		...
		static inline void beginFace( ::Dynamic _hx_,int face) {
			(_hx_.mPtr->*( static_cast< ::kha::graphics4::Graphics_obj *>(_hx_.mPtr->_hx_getInterface(0xba2f5490)))->_hx_beginFace)(face);
		}
		void (hx::Object :: *_hx_beginEye)(int eye); 
		static inline void beginEye( ::Dynamic _hx_,int eye) {
			(_hx_.mPtr->*( static_cast< ::kha::graphics4::Graphics_obj *>(_hx_.mPtr->_hx_getInterface(0xba2f5490)))->_hx_beginEye)(eye);
		}
		...
		static inline void setTextureArray( ::Dynamic _hx_,::Dynamic unit, ::kha::Image texture) {
			(_hx_.mPtr->*( static_cast< ::kha::graphics4::Graphics_obj *>(_hx_.mPtr->_hx_getInterface(0xba2f5490)))->_hx_setTextureArray)(unit,texture);
		}
		...
		static inline void setImageTexture( ::Dynamic _hx_,::Dynamic unit, ::kha::Image texture) {
			(_hx_.mPtr->*( static_cast< ::kha::graphics4::Graphics_obj *>(_hx_.mPtr->_hx_getInterface(0xba2f5490)))->_hx_setImageTexture)(unit,texture);
		}
		void (hx::Object :: *_hx_setTextureParameters)(::Dynamic texunit, ::kha::graphics4::TextureAddressing uAddressing, ::kha::graphics4::TextureAddressing vAddressing, ::kha::graphics4::TextureFilter minificationFilter, ::kha::graphics4::TextureFilter magnificationFilter, ::kha::graphics4::MipMapFilter mipmapFilter); 
		static inline void setTextureParameters( ::Dynamic _hx_,::Dynamic texunit, ::kha::graphics4::TextureAddressing uAddressing, ::kha::graphics4::TextureAddressing vAddressing, ::kha::graphics4::TextureFilter minificationFilter, ::kha::graphics4::TextureFilter magnificationFilter, ::kha::graphics4::MipMapFilter mipmapFilter) {
		...
		void (hx::Object :: *_hx_setTexture3DParameters)(::Dynamic texunit, ::kha::graphics4::TextureAddressing uAddressing, ::kha::graphics4::TextureAddressing vAddressing, ::kha::graphics4::TextureAddressing wAddressing, ::kha::graphics4::TextureFilter minificationFilter, ::kha::graphics4::TextureFilter magnificationFilter, ::kha::graphics4::MipMapFilter mipmapFilter); 
		static inline void setTexture3DParameters( ::Dynamic _hx_,::Dynamic texunit, ::kha::graphics4::TextureAddressing uAddressing, ::kha::graphics4::TextureAddressing vAddressing, ::kha::graphics4::TextureAddressing wAddressing, ::kha::graphics4::TextureFilter minificationFilter, ::kha::graphics4::TextureFilter magnificationFilter, ::kha::graphics4::MipMapFilter mipmapFilter) {
			(_hx_.mPtr->*( static_cast< ::kha::graphics4::Graphics_obj *>(_hx_.mPtr->_hx_getInterface(0xba2f5490)))->_hx_setTexture3DParameters)(texunit,uAddressing,vAddressing,wAddressing,minificationFilter,magnificationFilter,mipmapFilter);
		}
		...
		static inline void setCubeMap( ::Dynamic _hx_,::Dynamic unit, ::kha::graphics4::CubeMap cubeMap) {
			(_hx_.mPtr->*( static_cast< ::kha::graphics4::Graphics_obj *>(_hx_.mPtr->_hx_getInterface(0xba2f5490)))->_hx_setCubeMap)(unit,cubeMap);
		}
		...
		static inline void setCubeMapDepth( ::Dynamic _hx_,::Dynamic unit, ::kha::graphics4::CubeMap cubeMap) {
			(_hx_.mPtr->*( static_cast< ::kha::graphics4::Graphics_obj *>(_hx_.mPtr->_hx_getInterface(0xba2f5490)))->_hx_setCubeMapDepth)(unit,cubeMap);
		}
		...
		static inline void setMatrix3( ::Dynamic _hx_,::Dynamic location, ::kha::math::FastMatrix3 value) {
			(_hx_.mPtr->*( static_cast< ::kha::graphics4::Graphics_obj *>(_hx_.mPtr->_hx_getInterface(0xba2f5490)))->_hx_setMatrix3)(location,value);
		}

...
class HXCPP_CLASS_ATTRIBUTES FastMatrix3_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< FastMatrix3_obj > __new(float _00,float _10,float _20,float _01,float _11,float _21,float _02,float _12,float _22) {
			hx::ObjectPtr< FastMatrix3_obj > __this = new FastMatrix3_obj();
			__this->__construct(_00,_10,_20,_01,_11,_21,_02,_12,_22);
			return __this;
		}

		static hx::ObjectPtr< FastMatrix3_obj > __alloc(hx::Ctx *_hx_ctx,float _00,float _10,float _20,float _01,float _11,float _21,float _02,float _12,float _22) {

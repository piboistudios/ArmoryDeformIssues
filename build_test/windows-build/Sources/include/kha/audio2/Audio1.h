...
class HXCPP_CLASS_ATTRIBUTES Audio1_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< Audio1_obj > __new() {
			hx::ObjectPtr< Audio1_obj > __this = new Audio1_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< Audio1_obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		static void mix(int samples, ::kha::audio2::Buffer buffer);

...
HX_DEFINE_STACK_FRAME(_hx_pos_59d2c65c3027c2ec_32_new,"sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/cpp/_std/sys/io/FileInput.hx",32,0x418af150)
HX_LOCAL_STACK_FRAME(_hx_pos_59d2c65c3027c2ec_36_readByte,"sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/cpp/_std/sys/io/FileInput.hx",36,0x418af150)
HX_LOCAL_STACK_FRAME(_hx_pos_59d2c65c3027c2ec_47_readBytes,"sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/cpp/_std/sys/io/FileInput.hx",47,0x418af150)
HX_LOCAL_STACK_FRAME(_hx_pos_59d2c65c3027c2ec_63_seek,"sys.io.FileInput","seek",0x37d7f1ff,"sys.io.FileInput.seek","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/cpp/_std/sys/io/FileInput.hx",63,0x418af150)
namespace sys{
namespace io{

void FileInput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_59d2c65c3027c2ec_32_new)
...
int FileInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_59d2c65c3027c2ec_36_readByte)
HXDLIN(  36)		try {
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_GC_STACKFRAME(&_hx_pos_59d2c65c3027c2ec_47_readBytes)
HXDLIN(  47)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileInput_obj::seek(int p, ::sys::io::FileSeek pos){
            	HX_STACKFRAME(&_hx_pos_59d2c65c3027c2ec_63_seek)
HXDLIN(  63)		int _hx_tmp;
HXDLIN(  63)		if (hx::IsEq( pos,::sys::io::FileSeek_obj::SeekBegin_dyn() )) {
HXDLIN(  63)			_hx_tmp = (int)0;
            		}
            		else {
HXDLIN(  63)			if (hx::IsEq( pos,::sys::io::FileSeek_obj::SeekCur_dyn() )) {
HXDLIN(  63)				_hx_tmp = (int)1;
            			}
            			else {
HXDLIN(  63)				_hx_tmp = (int)2;
            			}
            		}

...
HX_LOCAL_STACK_FRAME(_hx_pos_ce5816ef02da3620_115_urlDecode,"StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/StringTools.hx",115,0x51328bec)
HX_LOCAL_STACK_FRAME(_hx_pos_ce5816ef02da3620_211_endsWith,"StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/StringTools.hx",211,0x51328bec)
HX_LOCAL_STACK_FRAME(_hx_pos_ce5816ef02da3620_245_isSpace,"StringTools","isSpace",0xe0290778,"StringTools.isSpace","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/StringTools.hx",245,0x51328bec)
HX_LOCAL_STACK_FRAME(_hx_pos_ce5816ef02da3620_262_ltrim,"StringTools","ltrim",0x24d2234a,"StringTools.ltrim","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/StringTools.hx",262,0x51328bec)
HX_LOCAL_STACK_FRAME(_hx_pos_ce5816ef02da3620_287_rtrim,"StringTools","rtrim",0x99399e50,"StringTools.rtrim","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/StringTools.hx",287,0x51328bec)
HX_LOCAL_STACK_FRAME(_hx_pos_ce5816ef02da3620_315_trim,"StringTools","trim",0x2908d066,"StringTools.trim","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/StringTools.hx",315,0x51328bec)
HX_LOCAL_STACK_FRAME(_hx_pos_ce5816ef02da3620_331_lpad,"StringTools","lpad",0x23bd8feb,"StringTools.lpad","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/StringTools.hx",331,0x51328bec)
HX_LOCAL_STACK_FRAME(_hx_pos_ce5816ef02da3620_386_replace,"StringTools","replace",0x6d651f30,"StringTools.replace","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/StringTools.hx",386,0x51328bec)
...
::String StringTools_obj::urlDecode(::String s){
            	HX_STACKFRAME(&_hx_pos_ce5816ef02da3620_115_urlDecode)
...
bool StringTools_obj::endsWith(::String s,::String end){
            	HX_STACKFRAME(&_hx_pos_ce5816ef02da3620_211_endsWith)
...
bool StringTools_obj::isSpace(::String s,int pos){
            	HX_STACKFRAME(&_hx_pos_ce5816ef02da3620_245_isSpace)
...
::String StringTools_obj::ltrim(::String s){
            	HX_STACKFRAME(&_hx_pos_ce5816ef02da3620_262_ltrim)
...
::String StringTools_obj::rtrim(::String s){
            	HX_STACKFRAME(&_hx_pos_ce5816ef02da3620_287_rtrim)
...
::String StringTools_obj::trim(::String s){
            	HX_STACKFRAME(&_hx_pos_ce5816ef02da3620_315_trim)
...
::String StringTools_obj::lpad(::String s,::String c,int l){
            	HX_STACKFRAME(&_hx_pos_ce5816ef02da3620_331_lpad)
...
::String StringTools_obj::replace(::String s,::String sub,::String by){
            	HX_STACKFRAME(&_hx_pos_ce5816ef02da3620_386_replace)

...
HX_LOCAL_STACK_FRAME(_hx_pos_6a5f4c66a2d0e285_113_initTranslucency,"armory.renderpath.Inc","initTranslucency",0xde778bd0,"armory.renderpath.Inc.initTranslucency","armory/renderpath/Inc.hx",113,0x90d3121f)
HX_LOCAL_STACK_FRAME(_hx_pos_6a5f4c66a2d0e285_141_drawTranslucency,"armory.renderpath.Inc","drawTranslucency",0x0a4c1ac4,"armory.renderpath.Inc.drawTranslucency","armory/renderpath/Inc.hx",141,0x90d3121f)
static const ::String _hx_array_data_89c2639f_6[] = {
	HX_("revealage",d2,3b,e3,2e),
};
...
void Inc_obj::initTranslucency(){
            	HX_GC_STACKFRAME(&_hx_pos_6a5f4c66a2d0e285_113_initTranslucency)
HXLINE( 114)		::armory::renderpath::Inc_obj::path->createDepthBuffer(HX_("main",39,38,56,48),HX_("DEPTH24",65,93,1e,ea));
HXLINE( 116)		 ::iron::RenderTargetRaw t =  ::iron::RenderTargetRaw_obj::__alloc( HX_CTX );
HXLINE( 117)		t->name = HX_("accum",d9,e9,99,1b);
HXLINE( 118)		t->width = (int)0;
HXLINE( 119)		t->height = (int)0;
HXLINE( 120)		t->displayp = null();
HXLINE( 121)		t->format = HX_("RGBA64",f2,5c,88,d6);
HXLINE( 122)		Float ss = (int)1;
HXLINE( 123)		if ((ss != (int)1)) {
HXLINE( 123)			t->scale = ss;
            		}
HXLINE( 124)		t->depth_buffer = HX_("main",39,38,56,48);
HXLINE( 125)		::armory::renderpath::Inc_obj::path->createRenderTarget(t);
HXLINE( 127)		 ::iron::RenderTargetRaw t1 =  ::iron::RenderTargetRaw_obj::__alloc( HX_CTX );
HXLINE( 128)		t1->name = HX_("revealage",d2,3b,e3,2e);
HXLINE( 129)		t1->width = (int)0;
HXLINE( 130)		t1->height = (int)0;
HXLINE( 131)		t1->displayp = null();
HXLINE( 132)		t1->format = HX_("R16",b7,63,3e,00);
HXLINE( 133)		Float ss1 = (int)1;
HXLINE( 134)		if ((ss1 != (int)1)) {
HXLINE( 134)			t1->scale = ss1;
            		}
HXLINE( 135)		t1->depth_buffer = HX_("main",39,38,56,48);
HXLINE( 136)		::armory::renderpath::Inc_obj::path->createRenderTarget(t1);
HXLINE( 138)		::armory::renderpath::Inc_obj::path->loadShader(HX_("shader_datas/translucent_resolve/translucent_resolve",1d,76,a9,4a));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(Inc_obj,initTranslucency,(void))

void Inc_obj::drawTranslucency(::String target){
            	HX_STACKFRAME(&_hx_pos_6a5f4c66a2d0e285_141_drawTranslucency)
HXLINE( 142)		::armory::renderpath::Inc_obj::path->setTarget(HX_("accum",d9,e9,99,1b),null(),null());
HXLINE( 143)		::armory::renderpath::Inc_obj::path->clearTarget((int)-16777216,null());
HXLINE( 144)		::armory::renderpath::Inc_obj::path->setTarget(HX_("revealage",d2,3b,e3,2e),null(),null());
HXLINE( 145)		::armory::renderpath::Inc_obj::path->clearTarget((int)-1,null());
HXLINE( 146)		::armory::renderpath::Inc_obj::path->setTarget(HX_("accum",d9,e9,99,1b),::Array_obj< ::String >::fromData( _hx_array_data_89c2639f_6,1),null());
HXLINE( 149)		::armory::renderpath::Inc_obj::bindShadowMap();
HXLINE( 152)		::armory::renderpath::Inc_obj::path->drawMeshes(HX_("translucent",99,20,66,03));
HXLINE( 155)		::armory::renderpath::Inc_obj::path->setTarget(target,null(),null());
HXLINE( 162)		::armory::renderpath::Inc_obj::path->bindTarget(HX_("accum",d9,e9,99,1b),HX_("gbuffer0",a9,8d,dc,b4));
HXLINE( 163)		::armory::renderpath::Inc_obj::path->bindTarget(HX_("revealage",d2,3b,e3,2e),HX_("gbuffer1",aa,8d,dc,b4));
HXLINE( 164)		::armory::renderpath::Inc_obj::path->drawShader(HX_("shader_datas/translucent_resolve/translucent_resolve",1d,76,a9,4a));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Inc_obj,drawTranslucency,(void))
...
bool Inc_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"initTranslucency") ) { outValue = initTranslucency_dyn(); return true; }
		if (HX_FIELD_EQ(inName,"drawTranslucency") ) { outValue = drawTranslucency_dyn(); return true; }
...
static ::String Inc_obj_sStaticFields[] = {
	...
	HX_HCSTRING("initTranslucency","\x21","\x36","\x38","\xe9"),
	HX_HCSTRING("drawTranslucency","\x15","\xc5","\x0c","\x15"),

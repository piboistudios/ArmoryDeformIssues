...
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_172_almostEquals,"iron.math.Vec4","almostEquals",0x90fe0bbb,"iron.math.Vec4.almostEquals","iron/math/Vec4.hx",172,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_176_length,"iron.math.Vec4","length",0xa91d0a54,"iron.math.Vec4.length","iron/math/Vec4.hx",176,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_179_sub,"iron.math.Vec4","sub",0x8372a352,"iron.math.Vec4.sub","iron/math/Vec4.hx",179,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_196_distanceTo,"iron.math.Vec4","distanceTo",0xfc74987e,"iron.math.Vec4.distanceTo","iron/math/Vec4.hx",196,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_199_reflect,"iron.math.Vec4","reflect",0xb1dacf0f,"iron.math.Vec4.reflect","iron/math/Vec4.hx",199,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_207_clamp,"iron.math.Vec4","clamp",0x0383054d,"iron.math.Vec4.clamp","iron/math/Vec4.hx",207,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_236_toString,"iron.math.Vec4","toString",0x0adefd9a,"iron.math.Vec4.toString","iron/math/Vec4.hx",236,0x1ba9f11e)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_185_distance,"iron.math.Vec4","distance",0x3e69c023,"iron.math.Vec4.distance","iron/math/Vec4.hx",185,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_188_distancef,"iron.math.Vec4","distancef",0x5e1e5ee3,"iron.math.Vec4.distancef","iron/math/Vec4.hx",188,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_221_xAxis,"iron.math.Vec4","xAxis",0xfe92778b,"iron.math.Vec4.xAxis","iron/math/Vec4.hx",221,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_222_yAxis,"iron.math.Vec4","yAxis",0x91f90c0c,"iron.math.Vec4.yAxis","iron/math/Vec4.hx",222,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_223_zAxis,"iron.math.Vec4","zAxis",0x255fa08d,"iron.math.Vec4.zAxis","iron/math/Vec4.hx",223,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_224_one,"iron.math.Vec4","one",0x836f9438,"iron.math.Vec4.one","iron/math/Vec4.hx",224,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_225_zero,"iron.math.Vec4","zero",0x8570ad16,"iron.math.Vec4.zero","iron/math/Vec4.hx",225,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_226_back,"iron.math.Vec4","back",0x75907815,"iron.math.Vec4.back","iron/math/Vec4.hx",226,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_227_forward,"iron.math.Vec4","forward",0xae7c2c97,"iron.math.Vec4.forward","iron/math/Vec4.hx",227,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_228_down,"iron.math.Vec4","down",0x76ed9650,"iron.math.Vec4.down","iron/math/Vec4.hx",228,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_229_up,"iron.math.Vec4","up",0x9cb70cc9,"iron.math.Vec4.up","iron/math/Vec4.hx",229,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_230_left,"iron.math.Vec4","left",0x7c2fa5f5,"iron.math.Vec4.left","iron/math/Vec4.hx",230,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_231_right,"iron.math.Vec4","right",0xa48e9e2e,"iron.math.Vec4.right","iron/math/Vec4.hx",231,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_232_negativeInfinity,"iron.math.Vec4","negativeInfinity",0xb233c16b,"iron.math.Vec4.negativeInfinity","iron/math/Vec4.hx",232,0x1ba9f11e)
HX_LOCAL_STACK_FRAME(_hx_pos_a4ebb82b51b50c55_233_positiveInfinity,"iron.math.Vec4","positiveInfinity",0x608c25af,"iron.math.Vec4.positiveInfinity","iron/math/Vec4.hx",233,0x1ba9f11e)
namespace iron{
namespace math{
...
bool Vec4_obj::almostEquals( ::iron::math::Vec4 v,Float prec){
            	HX_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_172_almostEquals)
HXDLIN( 172)		bool _hx_tmp;
HXDLIN( 172)		if ((::Math_obj::abs((this->x - v->x)) < prec)) {
HXDLIN( 172)			_hx_tmp = (::Math_obj::abs((this->y - v->y)) < prec);
            		}
            		else {
HXDLIN( 172)			_hx_tmp = false;
            		}
HXDLIN( 172)		if (_hx_tmp) {
HXDLIN( 172)			return (::Math_obj::abs((this->z - v->z)) < prec);
            		}
            		else {
...
float Vec4_obj::length(){
            	HX_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_176_length)
HXDLIN( 176)		float v = (this->x * this->x);
HXDLIN( 176)		float v1 = (v + (this->y * this->y));
HXDLIN( 176)		return ::Math_obj::sqrt((v1 + (this->z * this->z)));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,length,return )
 ...
 ::iron::math::Vec4 Vec4_obj::sub( ::iron::math::Vec4 v){
            	HX_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_179_sub)
HXLINE( 180)		 ::iron::math::Vec4 _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 180)		_hx_tmp->x = (_hx_tmp->x - v->x);
HXDLIN( 180)		 ::iron::math::Vec4 _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 180)		_hx_tmp1->y = (_hx_tmp1->y - v->y);
HXDLIN( 180)		 ::iron::math::Vec4 _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 180)		_hx_tmp2->z = (_hx_tmp2->z - v->z);
...
float Vec4_obj::distanceTo( ::iron::math::Vec4 p){
            	HX_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_196_distanceTo)
HXDLIN( 196)		float v = (p->x - this->x);
HXDLIN( 196)		float v1 = (v * (p->x - this->x));
HXDLIN( 196)		float v2 = (p->y - this->y);
HXDLIN( 196)		float v3 = (v1 + (v2 * (p->y - this->y)));
HXDLIN( 196)		float v4 = (p->z - this->z);
HXDLIN( 196)		return ::Math_obj::sqrt((v3 + (v4 * (p->z - this->z))));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Vec4_obj,distanceTo,return )
 ...
 ::iron::math::Vec4 Vec4_obj::reflect( ::iron::math::Vec4 n){
            	HX_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_199_reflect)
HXLINE( 200)		float d = this->dot(n);
HXLINE( 201)		float _hx_tmp = this->x;
HXDLIN( 201)		this->x = (_hx_tmp - ((((Float)2.0) * d) * n->x));
HXLINE( 202)		float _hx_tmp1 = this->y;
HXDLIN( 202)		this->y = (_hx_tmp1 - ((((Float)2.0) * d) * n->y));
HXLINE( 203)		float _hx_tmp2 = this->z;
HXDLIN( 203)		this->z = (_hx_tmp2 - ((((Float)2.0) * d) * n->z));
...
HX_DEFINE_DYNAMIC_FUNC1(Vec4_obj,reflect,return )
 ...
 ::iron::math::Vec4 Vec4_obj::clamp(float fmin,float fmax){
            	HX_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_207_clamp)
HXLINE( 208)		float v = (this->x * this->x);
HXDLIN( 208)		float v1 = (v + (this->y * this->y));
HXDLIN( 208)		float n = ::Math_obj::sqrt((v1 + (this->z * this->z)));
HXLINE( 209)		 ::iron::math::Vec4 v2 = hx::ObjectPtr<OBJ_>(this);
HXLINE( 211)		if ((n < fmin)) {
HXLINE( 212)			 ::iron::math::Vec4 v3 = this->normalize();
HXDLIN( 212)			v3 = this->mult(fmin);
HXDLIN( 212)			v2 = v3;
            		}
            		else {
HXLINE( 214)			if ((n > fmax)) {
HXLINE( 215)				 ::iron::math::Vec4 v4 = this->normalize();
HXDLIN( 215)				v4 = this->mult(fmax);
HXDLIN( 215)				v2 = v4;
            			}
            		}
HXLINE( 217)		return v2;
            	}
...
::String Vec4_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_236_toString)
HXDLIN( 236)		::String _hx_tmp = ((HX_("(",28,00,00,00) + ::Std_obj::string(this->x)) + HX_(", ",74,26,00,00));
HXDLIN( 236)		::String _hx_tmp1 = ((_hx_tmp + ::Std_obj::string(this->y)) + HX_(", ",74,26,00,00));
HXDLIN( 236)		::String _hx_tmp2 = ((_hx_tmp1 + ::Std_obj::string(this->z)) + HX_(", ",74,26,00,00));
HXDLIN( 236)		return ((_hx_tmp2 + ::Std_obj::string(this->w)) + HX_(")",29,00,00,00));
            	}
...
float Vec4_obj::distance( ::iron::math::Vec4 v1, ::iron::math::Vec4 v2){
            	HX_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_185_distance)
HXDLIN( 185)		float vx = (v1->x - v2->x);
HXDLIN( 185)		float vy = (v1->y - v2->y);
HXDLIN( 185)		float vz = (v1->z - v2->z);
HXDLIN( 185)		return ::Math_obj::sqrt((((vx * vx) + (vy * vy)) + (vz * vz)));
            	}
...
float Vec4_obj::distancef(float v1x,float v1y,float v1z,float v2x,float v2y,float v2z){
            	HX_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_188_distancef)
HXLINE( 189)		float vx = (v1x - v2x);
HXLINE( 190)		float vy = (v1y - v2y);
HXLINE( 191)		float vz = (v1z - v2z);
HXLINE( 192)		return ::Math_obj::sqrt((((vx * vx) + (vy * vy)) + (vz * vz)));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(Vec4_obj,distancef,return )
 ...
 ::iron::math::Vec4 Vec4_obj::xAxis(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_221_xAxis)
HXDLIN( 221)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,((Float)1.0),((Float)0.0),((Float)0.0),null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,xAxis,return )
 ...
 ::iron::math::Vec4 Vec4_obj::yAxis(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_222_yAxis)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,yAxis,return )
 ...
 ::iron::math::Vec4 Vec4_obj::zAxis(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_223_zAxis)
HXDLIN( 223)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,((Float)0.0),((Float)0.0),((Float)1.0),null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,zAxis,return )
 ...
 ::iron::math::Vec4 Vec4_obj::one(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_224_one)
HXDLIN( 224)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,((Float)1.0),((Float)1.0),((Float)1.0),null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,one,return )
 ...
 ::iron::math::Vec4 Vec4_obj::zero(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_225_zero)
HXDLIN( 225)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,((Float)0.0),((Float)0.0),((Float)0.0),((Float)0.0));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,zero,return )
 ...
 ::iron::math::Vec4 Vec4_obj::back(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_226_back)
HXDLIN( 226)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,((Float)0.0),((Float)-1.0),((Float)0.0),null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,back,return )
 ...
 ::iron::math::Vec4 Vec4_obj::forward(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_227_forward)
HXDLIN( 227)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,((Float)0.0),((Float)1.0),((Float)0.0),null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,forward,return )
 ...
 ::iron::math::Vec4 Vec4_obj::down(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_228_down)
HXDLIN( 228)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,((Float)0.0),((Float)0.0),((Float)-1.0),null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,down,return )
 ...
 ::iron::math::Vec4 Vec4_obj::up(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_229_up)
HXDLIN( 229)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,((Float)0.0),((Float)0.0),((Float)1.0),null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,up,return )
 ...
 ::iron::math::Vec4 Vec4_obj::left(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_230_left)
HXDLIN( 230)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,((Float)-1.0),((Float)0.0),((Float)0.0),null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,left,return )
 ...
 ::iron::math::Vec4 Vec4_obj::right(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_231_right)
HXDLIN( 231)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,((Float)1.0),((Float)0.0),((Float)0.0),null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,right,return )
 ...
 ::iron::math::Vec4 Vec4_obj::negativeInfinity(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_232_negativeInfinity)
HXDLIN( 232)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,::Math_obj::NEGATIVE_INFINITY,::Math_obj::NEGATIVE_INFINITY,::Math_obj::NEGATIVE_INFINITY,::Math_obj::NEGATIVE_INFINITY);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Vec4_obj,negativeInfinity,return )
 ...
 ::iron::math::Vec4 Vec4_obj::positiveInfinity(){
            	HX_GC_STACKFRAME(&_hx_pos_a4ebb82b51b50c55_233_positiveInfinity)
HXDLIN( 233)		return  ::iron::math::Vec4_obj::__alloc( HX_CTX ,::Math_obj::POSITIVE_INFINITY,::Math_obj::POSITIVE_INFINITY,::Math_obj::POSITIVE_INFINITY,::Math_obj::POSITIVE_INFINITY);
            	}
...
static ::String Vec4_obj_sMemberFields[] = {
	...
	HX_HCSTRING("almostEquals","\xcd","\xcf","\xa9","\x1b"),

...
HXLINE( 676)										f1 = (((Float)0.016666666666666666) * ::iron::_hx_system::Time_obj::scale);
            									}
            									else {
...
HXDLIN( 716)																						f1 = ((Float)f4 / (Float)(((Float)0.016666666666666666) * ::iron::_hx_system::Time_obj::scale));
            																					}
            																					else {

...
HX_DEFINE_STACK_FRAME(_hx_pos_f51c08b3b7340809_44_new,"List","new",0xed890070,"List.new","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/List.hx",44,0xc70bdba8)
HX_LOCAL_STACK_FRAME(_hx_pos_f51c08b3b7340809_52_add,"List","add",0xed7f2231,"List.add","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/List.hx",52,0xc70bdba8)
HX_LOCAL_STACK_FRAME(_hx_pos_f51c08b3b7340809_67_push,"List","push",0xebb5efca,"List.push","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/List.hx",67,0xc70bdba8)
HX_LOCAL_STACK_FRAME(_hx_pos_f51c08b3b7340809_81_first,"List","first",0x898acc40,"List.first","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/List.hx",81,0xc70bdba8)
HX_LOCAL_STACK_FRAME(_hx_pos_f51c08b3b7340809_161_iterator,"List","iterator",0x2d4cdfde,"List.iterator","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/List.hx",161,0xc70bdba8)

void List_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f51c08b3b7340809_44_new)
...
void List_obj::add( ::Dynamic item){
            	HX_GC_STACKFRAME(&_hx_pos_f51c08b3b7340809_52_add)
...
void List_obj::push( ::Dynamic item){
            	HX_GC_STACKFRAME(&_hx_pos_f51c08b3b7340809_67_push)
...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,push,(void))
 ...
 ::Dynamic List_obj::first(){
            	HX_STACKFRAME(&_hx_pos_f51c08b3b7340809_81_first)
HXDLIN(  81)		if (hx::IsNull( this->h )) {
HXDLIN(  81)			return null();
            		}
            		else {
HXDLIN(  81)			return this->h->item;
            		}
HXDLIN(  81)		return null();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(List_obj,first,return )
 ...
 ::_List::ListIterator List_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_f51c08b3b7340809_161_iterator)

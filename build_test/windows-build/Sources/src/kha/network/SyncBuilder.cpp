...
HX_LOCAL_STACK_FRAME(_hx_pos_03e8c0f9cc612cb3_8_boot,"kha.network.SyncBuilder","boot",0xa5736aca,"kha.network.SyncBuilder.boot","kha/network/SyncBuilder.hx",8,0x23cf542a)
HX_LOCAL_STACK_FRAME(_hx_pos_03e8c0f9cc612cb3_9_boot,"kha.network.SyncBuilder","boot",0xa5736aca,"kha.network.SyncBuilder.boot","kha/network/SyncBuilder.hx",9,0x23cf542a)
namespace kha{
namespace network{
...
bool SyncBuilder_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x226402b2;
}
...
{
	hx::Object *dummy = new SyncBuilder_obj;
	SyncBuilder_obj::_hx_vtable = *(void **)dummy;
...
{
{
            	HX_STACKFRAME(&_hx_pos_03e8c0f9cc612cb3_8_boot)
HXDLIN(   8)		nextId = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_03e8c0f9cc612cb3_9_boot)

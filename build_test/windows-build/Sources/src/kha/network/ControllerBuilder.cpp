...
HX_LOCAL_STACK_FRAME(_hx_pos_33f595a3f4a676e1_7_boot,"kha.network.ControllerBuilder","boot",0x356d120b,"kha.network.ControllerBuilder.boot","kha/network/ControllerBuilder.hx",7,0x77f946ab)
namespace kha{
namespace network{
...
bool ControllerBuilder_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7f1ad161;
}
...
{
	hx::Object *dummy = new ControllerBuilder_obj;
	ControllerBuilder_obj::_hx_vtable = *(void **)dummy;
...
{
{
            	HX_STACKFRAME(&_hx_pos_33f595a3f4a676e1_7_boot)
HXDLIN(   7)		nextId = (int)0;
            	}
}

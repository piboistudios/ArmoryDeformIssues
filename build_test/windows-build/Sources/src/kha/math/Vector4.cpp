...
bool Vector4_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7b04fbed;
}

Float Vector4_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_083dbf959f079b5a_26_get_length)
HXDLIN(  26)		Float _hx_tmp = (this->x * this->x);
HXDLIN(  26)		Float _hx_tmp1 = (_hx_tmp + (this->y * this->y));
HXDLIN(  26)		Float _hx_tmp2 = (_hx_tmp1 + (this->z * this->z));
HXDLIN(  26)		return ::Math_obj::sqrt((_hx_tmp2 + (this->w * this->w)));
            	}
...
HXLINE(  30)		Float currentLength = this->get_length();
HXLINE(  31)		if ((currentLength == (int)0)) {
HXLINE(  31)			return (int)0;
            		}
HXLINE(  32)		Float mul = ((Float)length / (Float)currentLength);

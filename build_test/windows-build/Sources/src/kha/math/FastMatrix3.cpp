...
bool FastMatrix3_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0e7d5146;
}
...
HXDLIN(  20)		return  ::kha::math::FastMatrix3_obj::__alloc( HX_CTX ,m->_00,m->_10,m->_20,m->_01,m->_11,m->_21,m->_02,m->_12,m->_22);
            	}
...
{
	hx::Object *dummy = new FastMatrix3_obj;
	FastMatrix3_obj::_hx_vtable = *(void **)dummy;

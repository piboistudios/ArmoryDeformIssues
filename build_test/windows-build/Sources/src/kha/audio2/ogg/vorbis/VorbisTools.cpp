...
HXLINE( 164)				{
HXLINE( 164)					Float val = ::Math_obj::sin((((Float)1.5707963267948966) * ::kha::audio2::ogg::vorbis::VorbisTools_obj::square(::Math_obj::sin(((((Float)(i + ((Float)0.5)) / (Float)n2) * ((Float)0.5)) * ((Float)3.14159265358979323846264))))));

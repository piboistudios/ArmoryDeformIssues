...
HXDLIN( 101)		this->data =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
...
bool Comment_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x290f4eab;
}
...
HXLINE( 116)			return ( (::String)(this->data->get(key)->__GetItem((int)0)) );
            		}
            		else {

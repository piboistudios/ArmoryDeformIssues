...
HX_LOCAL_STACK_FRAME(_hx_pos_4b15397845e057ac_303_drawAlignedCharacters,"kha.graphics2.GraphicsExtension","drawAlignedCharacters",0x438c577f,"kha.graphics2.GraphicsExtension.drawAlignedCharacters","kha/graphics2/GraphicsExtension.hx",303,0xb3e4f63d)
namespace kha{
namespace graphics2{
...
HXLINE( 280)		Float xoffset = ((Float)0.0);
HXLINE( 281)		bool _hx_tmp;
HXDLIN( 281)		if (hx::IsNotEq( horAlign,::kha::graphics2::HorTextAlignment_obj::TextCenter_dyn() )) {
HXLINE( 281)			_hx_tmp = hx::IsEq( horAlign,::kha::graphics2::HorTextAlignment_obj::TextRight_dyn() );
            		}
            		else {
HXLINE( 281)			_hx_tmp = true;
            		}
HXDLIN( 281)		if (_hx_tmp) {
HXLINE( 282)			 ::kha::Kravur width = g2->get_font();
HXDLIN( 282)			Float width1 = width->width(g2->get_fontSize(),text);
HXLINE( 283)			if (hx::IsEq( horAlign,::kha::graphics2::HorTextAlignment_obj::TextCenter_dyn() )) {
HXLINE( 284)				xoffset = (-(width1) * ((Float)0.5));
            			}
            			else {
HXLINE( 287)				xoffset = -(width1);
            			}
            		}
HXLINE( 290)		Float yoffset = ((Float)0.0);
HXLINE( 291)		bool _hx_tmp1;
HXDLIN( 291)		if (hx::IsNotEq( verAlign,::kha::graphics2::VerTextAlignment_obj::TextMiddle_dyn() )) {
HXLINE( 291)			_hx_tmp1 = hx::IsEq( verAlign,::kha::graphics2::VerTextAlignment_obj::TextBottom_dyn() );
            		}
            		else {
HXLINE( 291)			_hx_tmp1 = true;
            		}
HXDLIN( 291)		if (_hx_tmp1) {
HXLINE( 292)			 ::kha::Kravur height = g2->get_font();
HXDLIN( 292)			Float height1 = height->height(g2->get_fontSize());
HXLINE( 293)			if (hx::IsEq( verAlign,::kha::graphics2::VerTextAlignment_obj::TextMiddle_dyn() )) {
HXLINE( 294)				yoffset = (-(height1) * ((Float)0.5));
            			}
            			else {
HXLINE( 297)				yoffset = -(height1);
            			}
            		}
HXLINE( 300)		g2->drawString(text,(x + xoffset),(y + yoffset));
            	}
...
void GraphicsExtension_obj::drawAlignedCharacters( ::kha::graphics2::Graphics g2,::Array< int > text,int start,int length,Float x,Float y, ::kha::graphics2::HorTextAlignment horAlign, ::kha::graphics2::VerTextAlignment verAlign){
            	HX_STACKFRAME(&_hx_pos_4b15397845e057ac_303_drawAlignedCharacters)
HXLINE( 304)		Float xoffset = ((Float)0.0);
HXLINE( 305)		bool _hx_tmp;
HXDLIN( 305)		if (hx::IsNotEq( horAlign,::kha::graphics2::HorTextAlignment_obj::TextCenter_dyn() )) {
HXLINE( 305)			_hx_tmp = hx::IsEq( horAlign,::kha::graphics2::HorTextAlignment_obj::TextRight_dyn() );
            		}
            		else {
HXLINE( 305)			_hx_tmp = true;
            		}
HXDLIN( 305)		if (_hx_tmp) {
HXLINE( 306)			 ::kha::Kravur width = g2->get_font();
HXDLIN( 306)			Float width1 = width->widthOfCharacters(g2->get_fontSize(),text,start,length);
HXLINE( 307)			if (hx::IsEq( horAlign,::kha::graphics2::HorTextAlignment_obj::TextCenter_dyn() )) {
HXLINE( 308)				xoffset = (-(width1) * ((Float)0.5));
            			}
            			else {
HXLINE( 311)				xoffset = -(width1);
            			}
            		}
HXLINE( 314)		Float yoffset = ((Float)0.0);
HXLINE( 315)		bool _hx_tmp1;
HXDLIN( 315)		if (hx::IsNotEq( verAlign,::kha::graphics2::VerTextAlignment_obj::TextMiddle_dyn() )) {
HXLINE( 315)			_hx_tmp1 = hx::IsEq( verAlign,::kha::graphics2::VerTextAlignment_obj::TextBottom_dyn() );
            		}
            		else {
HXLINE( 315)			_hx_tmp1 = true;
            		}
HXDLIN( 315)		if (_hx_tmp1) {
HXLINE( 316)			 ::kha::Kravur height = g2->get_font();
HXDLIN( 316)			Float height1 = height->height(g2->get_fontSize());
HXLINE( 317)			if (hx::IsEq( verAlign,::kha::graphics2::VerTextAlignment_obj::TextMiddle_dyn() )) {
HXLINE( 318)				yoffset = (-(height1) * ((Float)0.5));
            			}
            			else {
HXLINE( 321)				yoffset = -(height1);
            			}
            		}
HXLINE( 324)		g2->drawCharacters(text,start,length,(x + xoffset),(y + yoffset));
            	}

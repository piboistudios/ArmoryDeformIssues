...
void Graphics1_obj::__construct(::Dynamic canvas){
            	HX_STACKFRAME(&_hx_pos_61acc156bd8c0490_16_new)
HXDLIN(  16)		this->canvas = canvas;
            	}
...
bool Graphics1_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1d93997f;
}
...
void Graphics1_obj::begin(){
            	HX_STACKFRAME(&_hx_pos_61acc156bd8c0490_19_begin)
HXLINE(  20)		if (hx::IsNull( this->texture )) {
HXLINE(  21)			int _hx_tmp = ::kha::Canvas_obj::get_width(this->canvas);
HXDLIN(  21)			this->texture = ::kha::Image_obj::create(_hx_tmp,::kha::Canvas_obj::get_height(this->canvas),::kha::graphics4::TextureFormat_obj::RGBA32_dyn(),::kha::graphics4::Usage_obj::ReadableUsage_dyn());
            		}
...
HXLINE(  28)		::kha::Canvas_obj::get_g2(this->canvas)->begin(null(),null());
HXLINE(  29)		::kha::Canvas_obj::get_g2(this->canvas)->drawImage(this->texture,(int)0,(int)0);
...
HXDLIN(  37)		int pos = ((y * this->texture->get_realWidth()) * (int)4);
HXDLIN(  37)		int pos1 = (pos + (x * (int)4));
HXDLIN(  37)		_this->b[pos1] = color;
HXDLIN(  37)		::Array< unsigned char > _this1 = _this->b;
HXDLIN(  37)		_this1[(pos1 + (int)1)] = ((int)color >> (int)(int)8);
HXDLIN(  37)		::Array< unsigned char > _this2 = _this->b;
HXDLIN(  37)		_this2[(pos1 + (int)2)] = ((int)color >> (int)(int)16);
HXDLIN(  37)		::Array< unsigned char > _this3 = _this->b;
HXDLIN(  37)		_this3[(pos1 + (int)3)] = hx::UShr(color,(int)24);
            	}
...
{
	hx::Object *dummy = new Graphics1_obj;
	Graphics1_obj::_hx_vtable = *(void **)dummy;

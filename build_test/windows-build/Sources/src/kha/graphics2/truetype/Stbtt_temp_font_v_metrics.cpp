...
bool Stbtt_temp_font_v_metrics_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2f420d4c;
}
...
{
	hx::Object *dummy = new Stbtt_temp_font_v_metrics_obj;
	Stbtt_temp_font_v_metrics_obj::_hx_vtable = *(void **)dummy;

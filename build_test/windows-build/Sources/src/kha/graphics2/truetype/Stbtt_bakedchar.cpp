...
HX_DEFINE_STACK_FRAME(_hx_pos_e9be8653c209e72e_51_new,"kha.graphics2.truetype.Stbtt_bakedchar","new",0x49d21da0,"kha.graphics2.truetype.Stbtt_bakedchar.new","kha/graphics2/truetype/StbTruetype.hx",51,0x5d9e0de9)
namespace kha{
namespace graphics2{
namespace truetype{
...
{
	hx::Object *dummy = new Stbtt_bakedchar_obj;
	Stbtt_bakedchar_obj::_hx_vtable = *(void **)dummy;

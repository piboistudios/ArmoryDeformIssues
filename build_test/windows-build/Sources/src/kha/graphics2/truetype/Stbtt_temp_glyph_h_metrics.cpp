...
bool Stbtt_temp_glyph_h_metrics_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x74b63d97;
}
...
{
	hx::Object *dummy = new Stbtt_temp_glyph_h_metrics_obj;
	Stbtt_temp_glyph_h_metrics_obj::_hx_vtable = *(void **)dummy;

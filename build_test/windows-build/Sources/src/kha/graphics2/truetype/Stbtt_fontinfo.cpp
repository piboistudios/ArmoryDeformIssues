...
HX_DEFINE_STACK_FRAME(_hx_pos_ad5d07f812e15772_118_new,"kha.graphics2.truetype.Stbtt_fontinfo","new",0xce315f22,"kha.graphics2.truetype.Stbtt_fontinfo.new","kha/graphics2/truetype/StbTruetype.hx",118,0x5d9e0de9)
namespace kha{
namespace graphics2{
namespace truetype{
...
hx::Val Stbtt_fontinfo_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"data") ) { data=inValue.Cast<  ::kha::internal::BytesBlob >(); return inValue; }
...
static hx::StorageInfo Stbtt_fontinfo_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::kha::internal::BytesBlob*/ ,(int)offsetof(Stbtt_fontinfo_obj,data),HX_HCSTRING("data","\x2a","\x56","\x63","\x42")},
...
{
	hx::Object *dummy = new Stbtt_fontinfo_obj;
	Stbtt_fontinfo_obj::_hx_vtable = *(void **)dummy;

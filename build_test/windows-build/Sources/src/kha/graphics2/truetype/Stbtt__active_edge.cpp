...
HX_DEFINE_STACK_FRAME(_hx_pos_95359e1b7d695f50_165_new,"kha.graphics2.truetype.Stbtt__active_edge","new",0x39b4427c,"kha.graphics2.truetype.Stbtt__active_edge.new","kha/graphics2/truetype/StbTruetype.hx",165,0x5d9e0de9)
namespace kha{
namespace graphics2{
namespace truetype{
...
bool Stbtt__active_edge_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x11d58b64;
}
...
{
	hx::Object *dummy = new Stbtt__active_edge_obj;
	Stbtt__active_edge_obj::_hx_vtable = *(void **)dummy;

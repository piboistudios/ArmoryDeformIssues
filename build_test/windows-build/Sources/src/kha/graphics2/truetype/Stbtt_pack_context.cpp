...
static hx::StorageInfo Stbtt_pack_context_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::kha::internal::BytesBlob*/ ,(int)offsetof(Stbtt_pack_context_obj,pixels),HX_HCSTRING("pixels","\x2d","\xef","\xa9","\x8c")},
	{ hx::fsUnknown, 0, null()}
};
...
{
	hx::Object *dummy = new Stbtt_pack_context_obj;
	Stbtt_pack_context_obj::_hx_vtable = *(void **)dummy;

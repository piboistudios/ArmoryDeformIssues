...
HX_DEFINE_STACK_FRAME(_hx_pos_a0bea14738bd3c17_137_new,"kha.graphics2.truetype.Stbtt_vertex","new",0x518bfd89,"kha.graphics2.truetype.Stbtt_vertex.new","kha/graphics2/truetype/StbTruetype.hx",137,0x5d9e0de9)
namespace kha{
namespace graphics2{
namespace truetype{
...
bool Stbtt_vertex_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x733c090d;
}
...
{
	hx::Object *dummy = new Stbtt_vertex_obj;
	Stbtt_vertex_obj::_hx_vtable = *(void **)dummy;

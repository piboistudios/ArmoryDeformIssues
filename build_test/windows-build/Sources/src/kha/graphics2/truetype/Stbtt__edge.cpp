...
HX_DEFINE_STACK_FRAME(_hx_pos_3097488c5b0804d8_156_new,"kha.graphics2.truetype.Stbtt__edge","new",0x264beb3b,"kha.graphics2.truetype.Stbtt__edge.new","kha/graphics2/truetype/StbTruetype.hx",156,0x5d9e0de9)
namespace kha{
namespace graphics2{
namespace truetype{
...
bool Stbtt__edge_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x4646de93;
}
...
{
	hx::Object *dummy = new Stbtt__edge_obj;
	Stbtt__edge_obj::_hx_vtable = *(void **)dummy;

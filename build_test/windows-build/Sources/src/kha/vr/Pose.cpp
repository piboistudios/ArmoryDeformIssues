...
HXLINE(  12)		this->Orientation =  ::kha::math::Quaternion_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE(  13)		this->Position =  ::kha::math::Vector3_obj::__alloc( HX_CTX ,null(),null(),null());
            	}
...
bool Pose_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0041b9f9;
}
...
{
	hx::Object *dummy = new Pose_obj;
	Pose_obj::_hx_vtable = *(void **)dummy;

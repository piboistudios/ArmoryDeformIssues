...
void PipelineStateBase_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("conservativeRasterization","\x5a","\x18","\x5f","\xe7"));
...
static hx::StorageInfo PipelineStateBase_obj_sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(PipelineStateBase_obj,conservativeRasterization),HX_HCSTRING("conservativeRasterization","\x5a","\x18","\x5f","\xe7")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String PipelineStateBase_obj_sMemberFields[] = {
	...
	HX_HCSTRING("conservativeRasterization","\x5a","\x18","\x5f","\xe7"),
	::String(null()) };
...
{
	hx::Object *dummy = new PipelineStateBase_obj;
	PipelineStateBase_obj::_hx_vtable = *(void **)dummy;

...
HXDLIN( 959)		_hx_tmp->drawString(text,_hx_tmp1,_hx_tmp2,x,y,_hx_tmp3->__get((this->transformations->length - (int)1)).StaticCast<  ::kha::math::FastMatrix3 >(),::kha::graphics2::Graphics_obj::fontGlyphs);
            	}
...
HXDLIN( 966)		_hx_tmp->drawCharacters(text,start,length,_hx_tmp1,_hx_tmp2,x,y,_hx_tmp3->__get((this->transformations->length - (int)1)).StaticCast<  ::kha::math::FastMatrix3 >(),::kha::graphics2::Graphics_obj::fontGlyphs);
            	}

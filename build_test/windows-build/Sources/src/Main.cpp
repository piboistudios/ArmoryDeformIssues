...
HXLINE(  25)		::iron::object::BoneAnimation_obj::skinMaxBones = (int)20;
...
HXLINE(  44)			config->__SetField(HX_("window_w",28,c3,cd,7d),(int)960,hx::paccDynamic);
            		}
HXLINE(  45)		if (hx::IsNull( config->__Field(HX_("window_h",19,c3,cd,7d),hx::paccDynamic) )) {
HXLINE(  45)			config->__SetField(HX_("window_h",19,c3,cd,7d),(int)540,hx::paccDynamic);
            		}
...
HXLINE(  54)		::kha::System_obj::init( ::Dynamic(hx::Anon_obj::Create(9)
            			...
            			->setFixed(5,HX_("title",98,15,3b,10),HX_("test",52,c8,f9,4c))
...
HXDLIN(   4)		projectName = HX_("test",52,c8,f9,4c);
            	}
{

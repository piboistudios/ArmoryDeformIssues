...
HX_DEFINE_STACK_FRAME(_hx_pos_ac3a9d3bd3926ea3_33_new,"haxe.io.Bytes","new",0x3938d57d,"haxe.io.Bytes.new","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/io/Bytes.hx",33,0x337feb8b)
HX_LOCAL_STACK_FRAME(_hx_pos_ac3a9d3bd3926ea3_79_blit,"haxe.io.Bytes","blit",0xd098ac78,"haxe.io.Bytes.blit","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/io/Bytes.hx",79,0x337feb8b)
HX_LOCAL_STACK_FRAME(_hx_pos_ac3a9d3bd3926ea3_133_sub,"haxe.io.Bytes","sub",0x393cae9d,"haxe.io.Bytes.sub","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/io/Bytes.hx",133,0x337feb8b)
HX_LOCAL_STACK_FRAME(_hx_pos_ac3a9d3bd3926ea3_252_setDouble,"haxe.io.Bytes","setDouble",0xa657d930,"haxe.io.Bytes.setDouble","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/io/Bytes.hx",252,0x337feb8b)
HX_LOCAL_STACK_FRAME(_hx_pos_ac3a9d3bd3926ea3_275_setFloat,"haxe.io.Bytes","setFloat",0xdaed805d,"haxe.io.Bytes.setFloat","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/io/Bytes.hx",275,0x337feb8b)
HX_LOCAL_STACK_FRAME(_hx_pos_ac3a9d3bd3926ea3_360_getString,"haxe.io.Bytes","getString",0xa16beae4,"haxe.io.Bytes.getString","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/io/Bytes.hx",360,0x337feb8b)
HX_LOCAL_STACK_FRAME(_hx_pos_ac3a9d3bd3926ea3_440_toString,"haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/io/Bytes.hx",440,0x337feb8b)
HX_LOCAL_STACK_FRAME(_hx_pos_ac3a9d3bd3926ea3_462_alloc,"haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/io/Bytes.hx",462,0x337feb8b)
HX_LOCAL_STACK_FRAME(_hx_pos_ac3a9d3bd3926ea3_490_ofString,"haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/io/Bytes.hx",490,0x337feb8b)
HX_LOCAL_STACK_FRAME(_hx_pos_ac3a9d3bd3926ea3_561_ofData,"haxe.io.Bytes","ofData",0x4f3005e4,"haxe.io.Bytes.ofData","C:\\Armory_04_win64_b27\\Armory\\armsdk\\Kha\\Tools\\haxe\\std/haxe/io/Bytes.hx",561,0x337feb8b)
namespace haxe{
namespace io{

void Bytes_obj::__construct(int length,::Array< unsigned char > b){
            	HX_STACKFRAME(&_hx_pos_ac3a9d3bd3926ea3_33_new)
...
void Bytes_obj::blit(int pos, ::haxe::io::Bytes src,int srcpos,int len){
            	HX_STACKFRAME(&_hx_pos_ac3a9d3bd3926ea3_79_blit)
...
HX_DEFINE_DYNAMIC_FUNC4(Bytes_obj,blit,(void))
 ...
 ::haxe::io::Bytes Bytes_obj::sub(int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_ac3a9d3bd3926ea3_133_sub)
...
void Bytes_obj::setDouble(int pos,Float v){
            	HX_STACKFRAME(&_hx_pos_ac3a9d3bd3926ea3_252_setDouble)
...
void Bytes_obj::setFloat(int pos,Float v){
            	HX_STACKFRAME(&_hx_pos_ac3a9d3bd3926ea3_275_setFloat)
...
::String Bytes_obj::getString(int pos,int len){
            	HX_STACKFRAME(&_hx_pos_ac3a9d3bd3926ea3_360_getString)
...
::String Bytes_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_ac3a9d3bd3926ea3_440_toString)
...
HX_DEFINE_DYNAMIC_FUNC0(Bytes_obj,toString,return )
 ...
 ::haxe::io::Bytes Bytes_obj::alloc(int length){
            	HX_GC_STACKFRAME(&_hx_pos_ac3a9d3bd3926ea3_462_alloc)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,alloc,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_ac3a9d3bd3926ea3_490_ofString)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,ofString,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofData(::Array< unsigned char > b){
            	HX_GC_STACKFRAME(&_hx_pos_ac3a9d3bd3926ea3_561_ofData)

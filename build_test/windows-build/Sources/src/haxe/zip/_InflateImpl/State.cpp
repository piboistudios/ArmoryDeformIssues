...
static void State_obj_sVisitStatic(HX_VISIT_PARAMS) {
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("haxe.zip._InflateImpl.State","\xa0","\xc2","\x8b","\xf6"), hx::TCanCast< State_obj >,State_obj_sStaticFields,0,
	&__Create_State_obj, &__Create,
	&super::__SGetClass(), &CreateState_obj, State_obj_sMarkStatics
#ifdef HXCPP_VISIT_ALLOCS
    , State_obj_sVisitStatic
#endif
...
{
Block = hx::CreateEnum< State_obj >(HX_HCSTRING("Block","\x2d","\xe5","\x29","\x48"),1,0);
CData = hx::CreateEnum< State_obj >(HX_HCSTRING("CData","\x0d","\x60","\x15","\xc1"),2,0);
Crc = hx::CreateEnum< State_obj >(HX_HCSTRING("Crc","\xb4","\x3a","\x33","\x00"),4,0);
Dist = hx::CreateEnum< State_obj >(HX_HCSTRING("Dist","\x86","\x93","\x42","\x2d"),5,0);
DistOne = hx::CreateEnum< State_obj >(HX_HCSTRING("DistOne","\x80","\x36","\x2a","\x8b"),6,0);
Done = hx::CreateEnum< State_obj >(HX_HCSTRING("Done","\xa2","\x1c","\x47","\x2d"),7,0);
Flat = hx::CreateEnum< State_obj >(HX_HCSTRING("Flat","\xd9","\x37","\x97","\x2e"),3,0);
Head = hx::CreateEnum< State_obj >(HX_HCSTRING("Head","\x40","\x55","\xe4","\x2f"),0,0);
}

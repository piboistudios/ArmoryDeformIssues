...
static void ExtraField_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ExtraField_obj::FUtf8,"FUtf8");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ExtraField_obj_sVisitStatic(HX_VISIT_PARAMS) {
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("haxe.zip.ExtraField","\xdf","\xaf","\xf8","\x91"), hx::TCanCast< ExtraField_obj >,ExtraField_obj_sStaticFields,0,
	&__Create_ExtraField_obj, &__Create,
	&super::__SGetClass(), &CreateExtraField_obj, ExtraField_obj_sMarkStatics
#ifdef HXCPP_VISIT_ALLOCS
    , ExtraField_obj_sVisitStatic
#endif
...
{
FUtf8 = hx::CreateEnum< ExtraField_obj >(HX_HCSTRING("FUtf8","\x97","\x1c","\x94","\x86"),2,0);
}

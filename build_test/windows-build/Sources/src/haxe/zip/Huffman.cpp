...
static void Huffman_obj_sMarkStatics(HX_MARK_PARAMS) {
};

#ifdef HXCPP_VISIT_ALLOCS
static void Huffman_obj_sVisitStatic(HX_VISIT_PARAMS) {
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("haxe.zip.Huffman","\x38","\xd8","\x1f","\x47"), hx::TCanCast< Huffman_obj >,Huffman_obj_sStaticFields,0,
	&__Create_Huffman_obj, &__Create,
	&super::__SGetClass(), &CreateHuffman_obj, Huffman_obj_sMarkStatics
#ifdef HXCPP_VISIT_ALLOCS
    , Huffman_obj_sVisitStatic
#endif
